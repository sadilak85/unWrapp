        ...
        builder: (context, child) => new Stack(
          children: <Widget>[
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: FitnessAppTheme.mainAppColor.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      FitnessAppTheme.mainAppColor.withOpacity(0.2),
                      FitnessAppTheme.mainAppColor.withOpacity(0.5)
                    ],
            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: FitnessAppTheme.mainAppColor,
                  gradient: LinearGradient(
                    colors: [
                      FitnessAppTheme.mainAppColor.withOpacity(0.4),
                      FitnessAppTheme.mainAppColor
                    ],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
